...
async def getweather(city_name='New York', unit=python_weather.METRIC) -> dict:
...
'''
def fetch(city_name='New York') -> dict:
  try:
    weather = asyncio.run(getweather(city_name=city_name))
    forecast = {
